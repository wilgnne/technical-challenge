...
import { InvalidLengthDataRowParseError, InvalidNumberFormatDataRowParseError } from '../src/services/DataRowParseService/exeptions';
...
describe('DataRowParserService', () => {
  ...
  it('should parse valid data row with spaces correctly', () => {
    const rawData = '0000000070                              Palmer Prosacco00000007530000000003     1836.7420210308';
  ...
  it('should throw InvalidLengthDataRowParseError for invalid length', () => {
    const rawData = '123456789012345678901234567890123456789012345678901234567890123456789012345678901';
  ...
  it('should throw InvalidNumberFormatDataRowParseError for invalid date format in data', () => {
    const rawData = '0000000070                              Palmer Prosacco00000007530000000003     1836.742021AB08';
  ...
  it('Throws InvalidNumberFormatDataRowParseError for NaN in userId', () => {
    const rawData = 'ABC0000070                              Palmer Prosacco00000007530000000003     1836.7420210308';
  ...
  it('Throws InvalidNumberFormatDataRowParseError for NaN in orderId', () => {
    const rawData = '0000000070                              Palmer ProsaccoABC00007530000000003     1836.7420210308';
  ...
  it('Throws InvalidNumberFormatDataRowParseError for NaN in prodId', () => {
    const rawData = '0000000070                              Palmer Prosacco0000000753ABC0000003     1836.7420210308';
